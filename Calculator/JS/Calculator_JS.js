...
//This modifies values each time a button is clikced on.
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //operator es executed.
        let result = Perform_Calculation[operator](Value_Now, Value_of_Input);
        //Here we add a fixed amount of numbers after the deciaml.
...
function Update_Display() {
    //Makes use fo the calculator-screen class to target the 
    //input tage in the HTML document
    const display = document.querySelector('.calculator-screen');
    display.value = Calculator.Display_Value;
}

Update_Display();
//This sectin monitors button clicks
