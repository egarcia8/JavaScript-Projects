...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition check to see of it is the computer's turn.
        if (activePlayer === 'O') {
            //This function disables clicking for computer's turn.
            disableClick();
            //This function waits 1 second before the computer place an images and enables click.
...
//drawLine() function is called to a draw a line on the screen if the condition is met.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1);
        //This method inidcates the end point in our line.
        c.lineTo(x, y);
